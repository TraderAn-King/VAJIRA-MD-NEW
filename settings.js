...
module.exports = {
SESSION_ID: process.env.SESSION_ID === VAJIRA-MD=CZtmAaYL#ZMXZL197cAE2Rbu6OCruwQFibqqZN_s1M2zA95rAUYU 'true' : process.env.SESSION_ID,
OWNER_NUMBER: process.env.OWNER_NUMBER === 93730285765 'true' : process.env.OWNER_NUMBER,   
